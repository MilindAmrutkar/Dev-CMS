...
public class SendCustomerData extends AsyncTask<Customer, Integer, String> {
    private static String TAG = "SendCustomerData";
    String message;
    private Context context;
    private ProgressDialog progressDialog;
    private String username, password;

    public SendCustomerData(Context context, String username, String password) {
    ...
    protected String doInBackground(Customer... params) {
        ...
        String link = SetURL.SendCustomerData;
        ...
        try {
            ...
            data += "&" + URLEncoder.encode("json", "UTF-8")
                    + "=" + URLEncoder.encode(customer.getJSON(), "UTF-8");
            Log.i(TAG, "doInBackground: json: " + customer.getJSON());
